...
//    private String hintColor = "#676767";
    private String hintColor = "#f1dbc4";
    //黑色
    private String longDegreeColor = "#111111";

    private String shortDegreeColor = "#e9546b";
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        startAngle=a.getInteger(R.styleable.ColorArcProgressBar_start_angle,270);
    ...
    private void initView() {
        ...
        hintPaint.setColor(0xff000000);
        hintPaint.setTextAlign(Paint.Align.CENTER);

        //显示标题文字  第一行文字
        curSpeedPaint = new Paint();
        curSpeedPaint.setTextSize(30);
